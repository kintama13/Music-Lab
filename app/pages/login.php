...
<body>
    <header>
        <div class="logo-holder">
            <a href=""><img class="logo" src="<?=ROOT?>/assets/images/Music  Lab.png" style="border-radius: 25%;" alt=""></a>
        </div>
            ...
            <div class="main-nav">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-list">
                        ...
                        <div class="nav-item"><a href="">Lyrics</a></div>
                    </div>
                </div>
    ...
    <section class="content">
        ...
        <div class="login-holder">
            <form method="post">
                <center><img src="<?=ROOT?>/assets/images/Music  Lab.png" alt="" style="width: 150px; border-radius: 50%;border: solid thin #ccc;" ></center>
                <h2>Login</h2>
